...
class BattleRecordForm(forms.Form):
    ...
    final_kill = forms.BooleanField(label="尾刀", label_suffix="", required=False, default=False)
    comp_flag = forms.BooleanField(label="补偿刀", label_suffix="", required=False, default=False)