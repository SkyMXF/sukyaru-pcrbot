...
class BattleRecordForm(forms.Form):
    ...
    final_kill = forms.BooleanField(label="是尾刀", widget=forms.CheckboxInput(attrs={'type':'checkbox', 'value': "尾刀"}))
    comp_flag = forms.BooleanField(label="是补偿刀", widget=forms.CheckboxInput(attrs={'type':'checkbox', 'value': "补偿刀"}))